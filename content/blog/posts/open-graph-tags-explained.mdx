...
<InfoBox type="warning" title="One page, one og:image">
If a template reuses the same image for every page, shares of individual articles look generic or wrong. Give each important page its own 1200x630 preview.
</InfoBox>
...
Open Graph is one layer of your page's metadata. For how it fits together with title tags, meta descriptions, canonical URLs, and structured data, see the [complete guide to SEO meta tags](/blog/seo-meta-tags-complete-guide).
