...
faq:
  ...
  - question: "Which meta tags are most important for SEO?"
    answer: "The title tag, meta description, and structured data (JSON-LD) have the biggest impact in Google. Title and description control what users see and click, while structured data can earn you rich results. Meta keywords are ignored entirely, so skip them."
---
...
If you need to trim a description to size, a [character counter](/blog/how-to-use-a-character-counter) helps you stay within limits without guessing. For the deeper "how to" behind titles and descriptions, our [guide to writing SEO meta titles and descriptions](/blog/write-seo-meta-titles-and-descriptions) walks through phrasing, length, and intent matching step by step.
