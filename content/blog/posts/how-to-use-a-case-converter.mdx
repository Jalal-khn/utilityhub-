...
| App | How to change case |
| --- | --- |
| Microsoft Word | Select the text, then press **Shift + F3** to cycle between lowercase, UPPERCASE, and Capitalize Each Word |
| Google Docs | **Format > Text > Capitalization** - choose "lower case", "UPPER CASE", or "Title Case" |
| Excel | Use the **UPPER()**, **LOWER()**, or **PROPER()** formulas in a helper column (PROPER capitalizes the first letter of every word) |
